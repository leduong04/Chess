...
public class Client {
    ...
    public static void main(String[] args) {
        try {
            ...
            String message;
            while (true) {
                previousBoardState = readBoardFromFile("D:\\Project\\Project_Java\\Chess_Ant\\src\\chess_ant\\board.txt");
                if (isBoardStateChanged(previousBoardState)) {
                    message=readBoardFromFile("D:\\Project\\Project_Java\\Chess_Ant\\src\\chess_ant\\board.txt");
    ...
    public static void writeToFile(String data) {
        try {
            ...
            File file = new File("D:\\Project\\Project_Java\\Chess_Ant\\src\\chess_ant\\board.txt");
            if (file.exists()) {
                file.delete();
            }
